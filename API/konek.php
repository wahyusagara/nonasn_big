...
$FROM_IN	= false;
	...
	$sql	= "SELECT userID, terminalName,transactiontime, convert(char(30),transactiontime,20) from ngv_AuthLog where transactiontime > DATEADD(day,-7,GETDATE()) and isnull(userID,'') <> '' ORDER BY TransactionTime DESC;  ";
