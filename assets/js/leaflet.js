...
! function(t, e, i) {
    ...
    "object" == typeof module && "object" == typeof module.exports ? module.exports = o : "function" == typeof define && define.amd && define(o), "undefined" != typeof t && n(), o.Util = {
        ...
        function() {
            ...
            _on: function(t, e, n) {
                ...
                var r = n && n !== this && o.stamp(n),
                    a = {
                        fn: e,
                        ctx: n
                    };
                r || (r = "no_context", a.ctx = i);
                var h = s.listeners[r];
                h || (h = [], s.listeners[r] = h);
            ...
            _off: function(t, e, i) {
                ...
                if (this._events)
                    if (e) {
                        if (n = this._events[t], n && (s = i && i !== this && o.stamp(i), s || (s = "no_context"), r = n.listeners[s]))
                            for (a = 0, h = r.length; a < h; a++) {
                                var l = r[a];
                                if (l.fn === e) return l.fn = o.Util.falseFn, n.count--, void(h > 1 ? this._isFiring ? (n.listeners[s] = r.slice(), n.listeners[s].splice(a, 1)) : r.splice(a, 1) : delete n.listeners[s]);
                                0 === r.length && delete n.listeners[s]
                            }
                    } else if (n = this._events[t]) {
                    for (s in n.listeners)
                        for (r = n.listeners[s], a = 0, h = r.length; a < h; a++) r[a].fn = o.Util.falseFn;
            ...
            fire: function(t, e, i) {
                ...
                if (this._events) {
                    ...
                    if (s) {
                        this._isFiring = !0;
                        for (var r in s.listeners)
                            for (var a = s.listeners[r], h = 0, l = a.length; h < l; h++) {
                                var u = a[h];
                                u.fn.call(u.ctx || this, n)
                            }
                        this._isFiring = !1
                    }
                }
    ...
    s.addEventListener = s.on, s.removeEventListener = s.clearAllEventListeners = s.off, s.addOneTimeEventListener = s.once, s.fireEvent = s.fire, s.hasEventListeners = s.listens, o.Mixin = {
        ...
        function() {
            ...
            _updatePosition: function() {
                var t = this._map,
                    e = t.latLngToLayerPoint(this._latlng),
                    i = this._container,
            ...
            _animateZoom: function(t) {
                var e, i = this._map._latLngToNewLayerPoint(this._latlng, t.zoom, t.center);
                this.options.offset && (e = o.point(this.options.offset), i = i.add(e)), o.DomUtil.setPosition(this._container, i)
            },
            _getAnchor: function() {
            ...
            bindTooltip: function(t, e) {
                return t instanceof o.Tooltip ? (o.setOptions(t, e), this._tooltip = t, t._source = this) : (this._tooltip && !e || (this._tooltip = o.tooltip(e, this)), this._tooltip.setContent(t)), this._initTooltipInteractions(), this._tooltip.options.permanent && this.openTooltip(), this
            },
            ...
            _initTooltipInteractions: function(t) {
                if (t || !this._tooltipHandlersAdded) {
                    ...
                    this._tooltip.options.permanent || (i.mouseover = this._openTooltip, i.mouseout = this.closeTooltip, this._tooltip.options.sticky && (i.mousemove = this._moveTooltip), o.Browser.touch && (i.click = this._openTooltip)), this[e](i), this._tooltipHandlersAdded = !t
                }
            },
    ...
    o.DomEvent = {
        ...
        _onTouchEnd: function() {
            return this._moved && this._zooming ? (this._zooming = !1, o.Util.cancelAnimFrame(this._animRequest), o.DomEvent.off(e, "touchmove", this._onTouchMove).off(e, "touchend", this._onTouchEnd), void(this._map.options.zoomAnimation ? this._map._animateZoom(this._center, this._map._limitZoom(this._zoom), !0, this._map.options.snapZoom) : this._map._resetView(this._center, this._map._limitZoom(this._zoom)))) : void(this._zooming = !1)
        }
        ...
        _zoomIn: function(t) {
            this._disabled || this._map.zoomIn(this._map.options.zoomDelta * (t.shiftKey ? 3 : 1))
        },
        _zoomOut: function(t) {
            this._disabled || this._map.zoomOut(this._map.options.zoomDelta * (t.shiftKey ? 3 : 1))
        },
