			...
			<div class="col-sm-12 col-md-9 col-lg-9 col-xl-9 bg-contain bg-white border mb-4">
				...
				<form method="post" action="<?php echo base_url() . "index.php/dashboard/update_peg"?>">
					...
					<div class="form-group row">
						...
						<select name="xagama" class="form-control" id="list">
							<option selected value="<?php echo $pegawainya->agama; ?>"><?php echo $pegawainya->agama; ?></option>
				...
				<div class="text-center pb-3">
					...
					<input type="submit" class="btn btn-primary radius-full shadow-small" ng-disabled="processing" id="submit" name="dsubmit" value="Update" onclick="save()">
				</div>
				</form>
				<?php endforeach; ?>
			</div>
